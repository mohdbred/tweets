<div class="box">
    <div class="heading">
        <h1><img alt="" src="<?php echo theme_url('assets/images/review.png'); ?>"> Pages </h1>
                    ...
                    <ul id="content_types_dropdown">
                        <?php if ( ! empty($content_types_add_entry)): ?>
                            <?php foreach($content_types_add_entry as $content_type_id => $content_type_title): 
                                    if($content_type_title != 'Page' && $content_type_title != 'Email Templates') continue;  
                                ?>
            ...
            <tbody>
                <?php if ($Entries->exists()): ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo date( DATE_TIME_FORMAT, strtotime($Entry->modified_date)); ?></td>
