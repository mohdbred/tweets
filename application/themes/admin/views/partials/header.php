...
<!--        <link rel="stylesheet" type="text/css" href="<?php echo theme_url('/assets/css/bootstrap.css');  ?>" />
        <link rel="stylesheet" type="text/css" href="<?php echo theme_url('/assets/css/bootstrap.min.css');  ?>" />
        <link rel="stylesheet" type="text/css" href="<?php echo theme_url('/assets/js/jquery-ui/jquery-ui.min.css');  ?>" />-->
...
<!--        <script type="text/javascript" src="<?php echo theme_url('assets/js/jquery.min_1.js'); ?>"></script>
        <script type="text/javascript" src="<?php echo theme_url('assets/js/jquery-ui/jquery-ui.min.js'); ?>"></script>-->
...
<!--        <script type="text/javascript" src="<?php echo theme_url('assets/js/bootstrap.min.js'); ?>"></script>
        <script type="text/javascript" src="<?php echo theme_url('assets/js/form.js'); ?>"></script>
        <script type="text/javascript" src="<?php echo theme_url('assets/js/magazine.js'); ?>"></script>-->
